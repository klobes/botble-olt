...
use Botble\FiberHomeOLTManager\PanelSections\OltManagerPanelSetting;
    ...
    protected function registerMenuItems()
    {
        ...
        DashboardMenu::make()
            ->registerItem([
                ...
                'icon' => 'fa fa-server',
                'url' => null,//route('admin.fiberhome.dashboard'),
		...
		PanelSectionManager::beforeRendering(function (): void {
            PanelSectionManager::default()->register(OltManagerPanelSetting::class);
        });
    }
